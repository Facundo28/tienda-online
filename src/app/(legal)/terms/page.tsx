      ...
      <div className="max-w-4xl mx-auto px-4 py-12 prose text-gray-700">
        ...
        <div className="space-y-8">
            <section>
                ...
                <p>
                    Bienvenido a <strong>Market Online</strong>. Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web Market Online.
                    Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones en su totalidad. No continúes usando el sitio web Market Online si no aceptas todos los términos y condiciones establecidos en esta página.
                </p>
            </section>
            ...
            <section>
                ...
                <p className="mt-2">
                    Market Online se reserva el derecho de eliminar cuentas que contengan información falsa o que infrinjan nuestras políticas de uso.
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    Market Online actúa como intermediario tecnológico para conectar vendedores, compradores y proveedores de servicios logísticos ("Partners").
                </p>
                <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <section>
                ...
                <p>
                    A menos que se indique lo contrario, Market Online y/o sus licenciantes son propietarios de los derechos de propiedad intelectual de todo el material en Market Online. 
            ...
            <section>
                ...
                <p>
                    En ningún caso Market Online, ni sus directores, empleados, socios, agentes, proveedores o afiliados, serán responsables por daños indirectos, incidentales, especiales, consecuentes o punitivos, 
            ...
            <section>
                ...
                <p>
                    Si tienes alguna pregunta sobre estos Términos, por favor contáctanos en <a href="mailto:legal@marketonline.com" className="text-blue-600 hover:underline">legal@marketonline.com</a>.
                </p>
            </section>
        </div>
      </div>
