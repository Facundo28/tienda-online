  ...
  return (
    <details className="relative group">
      ...
      <div className="absolute right-0 z-50 mt-2 w-60 rounded-md border bg-white py-1 shadow-lg text-gray-800">
         ...
         <div className="flex flex-col text-right hidden sm:block px-4 py-2 border-b border-gray-50">
            <span className="text-sm font-medium leading-none flex items-center gap-1 justify-end mb-1">
                {user.name}
            </span>
            {roleBadge}
        </div>
