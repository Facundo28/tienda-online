      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight">Market E.C</h2>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://facebook.com/marketec" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-700/50 rounded-full hover:bg-green-600 transition-colors text-white" aria-label="Facebook">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://instagram.com/marketec" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-700/50 rounded-full hover:bg-green-600 transition-colors text-white" aria-label="Instagram">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://twitter.com/marketec" target="_blank" rel="noopener noreferrer" className="p-2 bg-green-700/50 rounded-full hover:bg-green-600 transition-colors text-white" aria-label="Twitter">
        ...
        <div className="pt-8 border-t border-green-700 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-green-200/60">
          <p>© 2025 Market E.C. Todos los derechos reservados.</p>
